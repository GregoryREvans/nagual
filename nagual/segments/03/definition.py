...
maker = evans.SegmentMaker(  # don't forget accents!
    ...
    commands=[
        ...
        evans.call(
            "Voice 1",
            grace_handler_03,
            lambda _: abjad.Selection(_).leaves().get([29, 31, 33]),
        ),
        evans.call(
            "Staff 1",
        ...
        evans.call(
            "Voice 2",
            grace_handler_03,
            lambda _: abjad.Selection(_).leaves().get([50]),
        ),
        evans.call(
            "Staff 2",
            grace_pitch_handler_03,
        ...
        evans.call(
            "Voice 3",
            grace_handler_03,
            lambda _: abjad.Selection(_).leaves().get([35]),
        ),
        evans.call(
            "Staff 3",
            grace_pitch_handler_03,
        ...
        evans.call(
            "Voice 4",
            grace_handler_03,
            lambda _: abjad.Selection(_).leaves().get([56, 58, 60]),
        ),
        evans.call(
            "Staff 4",
            grace_pitch_handler_03,
        ...
        evans.attach(
            "Global Context",
            abjad.Markup(r"\rehearsal-mark-markup D 6 -1"),
            baca.selectors.leaf(0),
        ),
        # evans.call(
        #     "Global Context",
